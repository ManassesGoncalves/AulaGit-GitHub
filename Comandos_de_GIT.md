...
Antes de mais nada, vamos entender o que é e como surgiu o **GIT**:

Em miados 1991 é criado o tão famoso LINUX como um projeto pessoal de um estudante finlandês chamado **Linus Torvalds**, com o intuito de criar um novo núcleo de sistema operacional.

Mas o que o Linux tem haver com o GIT?

Em 2002, o projeto do Kernel do linux começou usar uma DVCS (Distributed Version Control System) proprietária chamada BitKeeper, porem, em 2005 a empresa BitKeeper removeu o acesso gratuito que tinha pelo detentor dos direitos autorais, **Larry McVoy**.

Ainda em 2005, **Linus Torvalds** e sua comunidade alertou a necessidade de desenvolver sua própria ferramenta baseada em lições aprendidas ao usar o BitKeeper. Com isso nasceu o **GIT** e desde então essa ferramenta vem amadurecendo e evoluindo para ser de fácil uso e reter o máximo de qualidade.

###### Pode-se ler a história no próprio site do Git: [Acesse a história aqui](https://git-scm.com/book/pt-br/v2/Começando-Uma-Breve-História-do-Git)
...
- GIT instalado no seu sistema
  ...
  acesse [link para download do Git](https://git-scm.com/downloads)
